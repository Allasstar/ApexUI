// Program.cs
//
// THIS is all a framework user needs to write to get a working app.
// No boilerplate, no config, no XAML.
// Just: create widgets → connect callbacks → run.
